...
# participation plot ------------------------------------------------------
dat_P <- read_and_prepare_data(user = user, model = "participation_east")
...
ggsave("../Figures/3_participation_east.png", width = 5, height = 3)

# density matrix
plot_densityMatrix(dat_P, y_var = "participation",
                   age_groups = age_groups, period_groups = period_groups)
ggsave("../Figures/3_participation_matrix_east.png", width = 6, height = 4)



# travel frequency plot ---------------------------------------------------
dat_F <- read_and_prepare_data(user = user, model = "frequency_east")
...
ggsave("../Figures/3_frequency_east.png", width = 5, height = 3)

# density matrix
plot_densityMatrix(dat_F, y_var = "JS_Anzahl_URs_cat",
                   age_groups = age_groups, period_groups = period_groups)
ggsave("../Figures/3_frequency_matrix_east.png", width = 6, height = 4)



# relative travel expenses plot -------------------------------------------
dat_E <- read_and_prepare_data(user = user, model = "expenses_east")
...
ggsave("../Figures/3_descriptiveMatrix_east.png", width = 10, height = 6)
...
write.csv2(freq_dat, file = "../Figures/3_freqTable_covariates_east.csv", row.names = FALSE)
...
ggsave("../Figures/3_marginalEffects_east.png", width = 6, height = 4)
...
ggplot(plot_dat, mapping = aes(x = param, y = coef)) +
  ...
  theme(legend.position = "none",
        ...
        strip.background = element_rect(fill = gray(0.8)))
ggsave("../Figures/3_linearEffects_east.png", width = 8, height = 7)
...
ggplot() +
  ...
  theme(strip.background = element_rect(fill = gray(0.8)),
        legend.position  = "none")
ggsave("../Figures/3_incomeEffects_east.png", width = 6, height = 2)
