...
ggsave("Graphics/FigureC1.png", width = 10, height = 6, dpi = 300)
...
ggsave("Graphics/FigureC2.png", width = 6, height = 4, dpi = 300)
...
ggplot(plot_dat, mapping = aes(x = param, y = coef)) +
  ...
  theme(legend.position = "none",
        ...
        strip.background = element_rect(fill = gray(0.8)))
ggsave("Graphics/FigureC3.png", width = 8, height = 7, dpi = 300)
...
ggsave("Graphics/FigureC4.png", width = 6, height = 2, dpi = 300)
...
ggsave("Graphics/FigureD1.png", width = 7, height = 3.5, dpi = 300)
...
plot_dat %>% 
  ...
  theme(strip.background = element_rect(fill = gray(0.8)),
        legend.position  = "none",
        axis.title.x     = element_blank())
ggsave("Graphics/FigureD2.png", width = 6, height = 2, dpi = 300)
...
ggplot(plot_dat_linear, mapping = aes(x = param, y = coef)) +
  ...
  theme(legend.position = "none",
        ...
        axis.text.x     = element_text(angle = 45, hjust = 1),
        strip.background = element_rect(fill = gray(0.8)))
ggsave("Graphics/FigureD3.png", width = 8, height = 5, dpi = 300)
...
ggsave("Graphics/FigureD4.png", width = 6, height = 2.5, dpi = 300)
